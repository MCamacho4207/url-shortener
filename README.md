...
You can now view your running frontend application on http://localhost:3000 with backend requests running on http://localhost:8080 (Example: http://localhost:8080/url-shortener/urls)
